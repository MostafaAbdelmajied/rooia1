...
class AboutUsController extends Controller
{
    ...
    public function storeAboutUs(StoreAboutUsRequest $request)
    {
        ...
        return redirect()->route('admin.createAboutUs')->with('success', 'تم حفظ البيانات بنجاح!');
    }
    ...
    public function updateAboutUs(UpdateAboutUsRequest $request)
    {
        ...
        return redirect()->route('admin.editAboutUs')->with('success', 'تم تحديث البيانات بنجاح!');
    }
}
