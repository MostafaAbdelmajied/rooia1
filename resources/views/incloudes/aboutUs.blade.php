      ...
      <div class="col-md-6">
        <div class="img-and-bg">
          <div class="row align-items-center">
            <div class="col-6">
              @php
              $image1Path = url('public/img/admins/' . ($aboutUsData->image_1 ?? 'default.png'));
              @endphp
              <img src="{{ $image1Path }}" class="mx-2 img-fluid" style="width: 300px; height: 346px;"
                alt="صورة المجموعة">
            </div>
            <div class="col-6">
              @php
              $image2Path = url('public/img/admins/' . ($aboutUsData->image_2 ?? 'default.png'));
              @endphp
              <img src="{{ $image2Path }}" class="mx-2 img-fluid" style="width: 300px; height: 346px;"
                alt="صورة المجموعة">
            </div>
          </div>
        </div>
      ...
      <div class="col-md-6">
        ...
        <div class="three-descrip">
          ...
          <div class="decri d-flex align-items-center mt-3">
            <img src="{{ asset('public/icons/Group ' . (237640 + $loop->index) . '.png') }}"
