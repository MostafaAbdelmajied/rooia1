...
<head>
    ...
    <!--icons-site-->
    <link rel="icon" type="png" href="{{ url('public/img/logo.png') }}" />
    <!--icons-site-->
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <div class="navbar-brand d-lg-none mx-auto">
                    @foreach ($contacts as $contact)
                        @php
                            $logoPath = url('public/img/admins/' . $contact->logo);
                        @endphp
                        <img src="{{ $logoPath }}" style="width: 70px; height: 70px; border-radius: 50%;"
