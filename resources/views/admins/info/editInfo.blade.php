            ...
            @if ($info->video || $info->image1 || $info->image2 || $info->ar_description || $info->ar_additional_description)
                <form action="{{ route('admin.info.update') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($info->video)
                            <video width="160" height="120" controls style="object-fit: cover;">
                                <source src="{{ asset('public/img/videos/' . $info->video) }}" type="video/mp4">
                    ...
                    <div class="mb-3">
                        ...
                        @if ($info->image1)
                            <img src="{{ asset('public/img/admins/' . $info->image1) }}" alt="Image 1"
                    ...
                    <div class="mb-3">
                        ...
                        @if ($info->image2)
                            <img src="{{ asset('public/img/admins/' . $info->image2) }}" alt="Image 2"
                                style="width: 150px; height: 100px; object-fit: cover;">
                        @endif
                    </div>
                    <div class="mb-3">
