                ...
                <div class="col-md-6">
                    <div class="img-and-bg">
                        <div class="row align-items-center">
                            <div class="col-6">
                                <img src="{{ old('image_1', asset('public/img/default.png')) }}" class="mx-2 img-fluid"
                                    style="width: 300px; height: 346px;" alt="صورة المجموعة">
                                <input type="file" name="image_1" class="form-control mt-2">
                            </div>
                            <div class="col-6">
                                <img src="{{ old('image_2', asset('public/img/default.png')) }}" class="mx-2 img-fluid"
                    ...
                    <div class="title-contents">
                        <h2 class="mt-3 mb-2 text-capitalize fw-bold text-primary">
                            <input type="text" name="ar_title"
                                ...
                                placeholder="أدخل العنوان هنا" value="{{ old('ar_title') }}">
                        </h2>
                    </div>
                    ...
                    <div class="three-descrip">
                        @foreach (['ar_desc_1', 'ar_desc_2', 'ar_desc_3'] as $index => $desc)
                            <div class="decri d-flex align-items-center mt-3">
                                <img src="{{ asset('public/icons/Group ' . (237640 + $index) . '.png') }}" class="img-fluid mt-3 rounded-circle"
                                    style="width: 100px; height: 100px;" alt="">
                                <textarea name="{{ $desc }}" class="form-control mt-2" rows="2" placeholder="أدخل الوصف هنا">{{ old($desc) }}</textarea>
                            </div>
                        @endforeach
                    </div>
                </div>
